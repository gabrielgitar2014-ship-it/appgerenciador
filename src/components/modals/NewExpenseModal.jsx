...
export default function NewExpenseModal({
  ...
  useEffect(() => {
    if (isOpen) {
      if (expenseToEdit) {
        ...
        setBank(expenseToEdit.bank);
        setPaymentMonth(expenseToEdit.paymentMonth || "current");
        const isEditParcelado = !!expenseToEdit.parcela;
        setIsParcelado(isEditParcelado);
        if (isEditParcelado) {
          setTotalParcelas(expenseToEdit.parcela.totalParcelas);
          setValorTotalCompra(expenseToEdit.parcela.valorTotalCompra);
        }
      } else {
        setDescription("");
        setAmount("");
  ...
  }, [expenseToEdit, isOpen, selectedMonth]);
  ...
  const handleSave = () => {
    ...
    if (isParcelado) {
      ...
      parcelaInfo = {
        numeroDaParcela: expenseToEdit
          ? expenseToEdit.parcela.numeroDaParcela
          : 1,
